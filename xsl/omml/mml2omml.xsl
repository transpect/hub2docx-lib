...
-->
  ...
  <xsl:template mode="mml"
    ...
    <xsl:variable name="fFunctionName">
      ...
      <xsl:variable name="fShouldCollect"
                    select="($fLinearFracParent=0 and $fFunctionName=0) 
                            and 
                            (
                              parent::mml:mrow or parent::mml:mstyle 
                              or
                              parent::mml:msqrt or parent::mml:menclose 
                              or     
                              parent::mml:math or parent::mml:mphantom 
                              or 
                              parent::mml:mtd 
                              or
                              parent::mml:maction
  ...
  <!-- GI -->
  <xsl:template mode="mml" match="mml:none" />
